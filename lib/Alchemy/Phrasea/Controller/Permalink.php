...
class Permalink extends AbstractDelivery
{
    ...
    {
        if (in_array($subdef, [\databox_subdef::CLASS_PREVIEW, \databox_subdef::CLASS_THUMBNAIL]) && $app['EM']->getRepository('Phraseanet:FeedItem')->isRecordInPublicFeed($databox->get_sbas_id(), $record_id)) {
